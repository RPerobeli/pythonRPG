...
class Evil(GameState.GameState):
    ...
    def VerifyEvent(self):
        ...
        #region NPCs
        if(self.StoryTextList[self.StoryListId]['txt'] == "InserirFormaSombria\n"):
            self.Actors[0] = lib.GetNpc(self.Npcs,"Forma Sombria")
            self.StoryListId += 1
            self.VerifyEvent()
            return
        #endif
